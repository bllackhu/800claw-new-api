...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.POST("/provision/customer-token", middleware.AdminAuth(), controller.ProvisionCustomerToken)
		...
		logRoute.GET("/token_ranking", middleware.AdminAuth(), controller.GetTopTokenRequestCounts)
